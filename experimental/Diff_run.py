...
def run(experiment_name,generations,population):
    ...
    _OUTPUTSIZE_=3
    #microbial GA
    ga=Differential(generations,population,2,sex=1) #
    ...
    save_array_to_folder("/its/home/drs25/ant_trajectory/data/Diff/", experiment_name, history, pathways, ga,best_genotype,genes_time)
    ##########
    
if __name__=="__main__":
    run("sin_wave_100gens",2,10)