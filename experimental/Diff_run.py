...
plt.savefig("/its/home/drs25/ant_trajectory/data/Diff/fitness"+str(date)+".pdf")
plt.close()
del env
...
transform_model_trajects(pathways, 
    image_path="/its/home/drs25/ant_trajectory/trajectory_code/testA_ant1_image.jpg", savefig="/its/home/drs25/ant_trajectory/data/Diff/show"+date+".pdf", x_scale=1)
...
np.save("/its/home/drs25/ant_trajectory/data/Diff/trial"+date.replace(":","_"),pathways)
